      ...
      {!editing && (
        <>
          ...
          <div className="dos-browse">
            <div className="browse-grid browse-grid-header" style={{ gridTemplateColumns: sort === "worker" || sort === "default" ? "auto 30ch auto" : "max-content max-content max-content" }}>
            ...
            <div className="dos-browse-body">
              {rows.map((m, i) => (
                <button
                  ...
                  style={{ gridTemplateColumns: sort === "worker" || sort === "default" ? "auto 30ch auto" : "max-content max-content max-content" }}
